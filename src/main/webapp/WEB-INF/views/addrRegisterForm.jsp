...
<head>
    ...
    <link rel="stylesheet" href="css/addrRegisterForm.css">
                ...
                <table class="regTable">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="sample6_address" name="mainAddr" class="mainAddrInput" readonly><br>
                            <input type="text" id="sample6_detailAddress" name="detailAddr" class="detailAddrInput">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="telNum" name="telNum" class="telNumInput">
                        </td>
                    </tr>
                    <tr>
